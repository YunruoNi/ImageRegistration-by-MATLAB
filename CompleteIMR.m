...
%         disp(i);
          ...
          movingRegistered = imregister(movingVolume, fixedVolume, 'affine', optimizer, metric);
          ...
          %4.Save
          parsave (sprintf('/Users/n.y.r/Desktop/Aging/PPMRMATRESULT/%s.mat',fn), movingRegistered)
